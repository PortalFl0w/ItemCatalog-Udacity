# This file will populate the database with some dummy data.
...
category_bedroom = Category(
                    name="Bedroom",
                    owner_id=1
                    )
category_kitchen = Category(
                    name="Kitchen",
                    owner_id=1
                    )
category_livingroom = Category(
                    name="Living Room",
                    owner_id=1
                    )
category_decorations = Category(
                    name="Decorations",
                    owner_id=1
                    )
category_bathroom = Category(
                    name="Bathroom",
                    owner_id=1
                    )
...
item_bedroom_2 = Item(
                 name="Pillow Set - 4",
                 description="Soft Memory Foam Pillows",
                 price="60",
                 category=category_bedroom,
                 owner_id=1
                 )
...
item_kitchen_1 = Item(
                 name="Knife Set",
                 description="Very Sharp Stainless Steel Knives!",
                 price="65",
...
# Living Room Items
item_livingroom_1 = Item(
                    name="Sofa - 3 Seat",
                    description="Amazing extra-soft sofa, made in Germany.",
                    price="499",
                    category=category_livingroom,
                    owner_id=1
                    )
session.add(item_livingroom_1)

# Decoration Items
item_decorations_1 = Item(
                     name="Picture Frame - A3 Size",
                     description="Wooden picture frame with"
                                 " quick-mount feature.",
                     price="20",
                     category=category_decorations,
                     owner_id=1
                     )
session.add(item_decorations_1)

# Bathroom Items
item_bathroom_1 = Item(
                  name="Flusha - Dual Flush Ceramic Toilet",
                  description="Dual Flush and Quick "
                              "Flush options! Made in Sweden",
                  price="399",
